...
def get_files_and_stats_data():
    return stats_data, files_data
...
def get_message_history_and_last_message_id():
    global message_history
    last_id = message_history[-1]['id'] if message_history else 0
    return message_history, last_id
